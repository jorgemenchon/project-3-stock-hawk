...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
    ...
    StockAdapter(Context context, StockAdapterOnClickHandler clickHandler) {
        ...
        dollarFormat = GeneralUtils.getDollarFormat();
    ...
    public void onBindViewHolder(StockViewHolder holder, int position) {
        ...
        Integer id = cursor.getInt(Contract.Quote.POSITION_ID);
        ...
        if (rawAbsoluteChange > 0) {
            ...
            holder.change.setContentDescription(context.getString(R.string.cd_stock_up, holder.change.toString()));
        } else {
            holder.change.setBackgroundResource(R.drawable.percent_change_pill_red);
            holder.change.setContentDescription(context.getString(R.string.cd_stock_down, holder.change.toString()));
        }
        ...
        holder.itemView.setContentDescription(GeneralUtils.stockToString(context, stock));
    }
